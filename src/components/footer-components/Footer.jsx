                    ...
                    <div className="md:flex md:justify-between">
                        <div className="mb-6 md:mb-0">
                            <a href="#" className="flex items-center">
                                <img
                                    src="https://demoprestashop.aeipix.com/AX02/megadeal23/img/kenzy-fashion-logo-1542786700.jpg"
                                    className="h-12 me-3"
                                    alt="Logo"
                                />
                            </a>
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            <div>
                                <h2 className="mb-6 text-sm font-semibold text-gray-300 uppercase">Products</h2>
                                <ul className="text-gray-400 font-medium">
                                    {categories.map((category) => (
                                        <div key={category.id}>
                                            <li className="mb-2 hover:underline text-lg font-bold">{category.name}</li>
                                            <ul className="pl-4">
                                                {category.subCategories.map(subCategory => (
                                                    <li key={subCategory.id} className="mb-2 text-gray-500 hover:underline">
                                                        {subCategory.name}
                                                    </li>
                                                ))}
                                            </ul>
